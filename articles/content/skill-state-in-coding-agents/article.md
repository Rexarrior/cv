...
[сборщика состояния OpenCode](https://github.com/Rexarrior/skill-state-research/blob/main/opencode/packages/opencode/src/session/skill-state.ts) или
[ядра состояния Codex](https://github.com/Rexarrior/skill-state-research/blob/main/codex/codex-rs/core/src/skill_state.rs).

Ранние пробы, в том числе с GLM-5.2 и Luna, остались [в общем журнале](https://github.com/Rexarrior/skill-state-research/blob/main/journals/README.md).
...
- [CLI-менеджер задач](https://github.com/Rexarrior/skill-state-research/blob/main/experiments/skill-state/projects/taskboard-cli/SPEC.md) с сохранением данных в JSON;
- [утилиту анализа CSV](https://github.com/Rexarrior/skill-state-research/blob/main/experiments/skill-state/projects/csv-insights/SPEC.md);
- [небольшой шаблонизатор](https://github.com/Rexarrior/skill-state-research/blob/main/experiments/skill-state/projects/mini-template/SPEC.md);
- [HTTP key-value сервис](https://github.com/Rexarrior/skill-state-research/blob/main/experiments/skill-state/projects/http-kv/SPEC.md);
- [планировщик зависимостей](https://github.com/Rexarrior/skill-state-research/blob/main/experiments/skill-state/projects/dependency-planner/SPEC.md).

На каждый запуск агент получает полную спецификацию и пустую рабочую папку, после чего работает самостоятельно.
Получившийся проект проверяет внешний [оценщик](https://github.com/Rexarrior/skill-state-research/blob/main/experiments/skill-state/scripts/evaluate.ts).
...
[Первый аудит соответствия](https://github.com/Rexarrior/skill-state-research/blob/main/experiments/PAPER-CONFORMANCE.md) описывает реализацию и условия
основной серии из 120 запусков. Я сохранил его как исторический документ, а поздние изменения лимитов,
изоляции и сохранения состояния разобрал в [дополнении к аудиту](https://github.com/Rexarrior/skill-state-research/blob/main/experiments/PAPER-CONFORMANCE-20260910.md).
...
[отпечатки стартового контекста](https://github.com/Rexarrior/skill-state-research/blob/main/experiments/article-20260904/host-context-audit.json).
...
[Условия обеих серий и поправка к запуску](https://github.com/Rexarrior/skill-state-research/blob/main/experiments/codex-clean-comparison-20260908/README.md)
...
сами запуски. [Пересчёт старых таблиц](https://github.com/Rexarrior/skill-state-research/blob/main/journals/TOKEN-ACCOUNTING-CORRECTION.md) сохранён отдельно,
...
удачными попытками. Подробности [проверок реализации](https://github.com/Rexarrior/skill-state-research/blob/main/experiments/article-20260904/VERIFICATION.md)
и [правила исключения диагностических запусков](https://github.com/Rexarrior/skill-state-research/blob/main/experiments/article-20260904/PROTOCOL.md) вынесены отдельно.
...
![Paper против Native: input слева и обращения к модели справа, по каждой задаче](./assets/input-cycles-paper-vs-native.png)
...
![V2 против Native: input слева и обращения к модели справа, по каждой задаче](./assets/input-cycles-v2-vs-native.png)
...
![V3 против Native: input и обращения к модели по каждой задаче](./assets/input-cycles-v3-vs-native.png)
...
![V3 против V2: input и обращения к модели по каждой задаче основной попытки](./assets/input-cycles-v3-vs-v2.png)
...
[Обе версии оценок и все повторы](https://github.com/Rexarrior/skill-state-research/blob/main/experiments/codex-sol-controls-20260906/COMPARE-FOUR.md)
сохранены вместе с [объяснением исправления](https://github.com/Rexarrior/skill-state-research/blob/main/experiments/codex-sol-repeats-20260906/EVALUATOR-NOTE.md).

![Десять повторов Codex/Sol: средний input, число обращений и фактическое время на задачу](./assets/codex-sol-ten-repeats-input-cycles-time.png)
...
Подробнее — в [полном отчёте](https://github.com/Rexarrior/skill-state-research/blob/main/experiments/codex-sol-controls-20260906/RESULTS.md).
...
![Пять повторов Codex/Sol без глобальных скиллов: input, циклы и наблюдаемое время на задачу](./assets/codex-sol-clean-five-repeats-input-cycles-time.png)
...
[Отчёт Sol с проверками, повторами и исходными счётчиками](https://github.com/Rexarrior/skill-state-research/blob/main/experiments/codex-clean-comparison-20260908/REPORT-sol.md).
...
![Пять повторов Codex/Astra без глобальных скиллов: input, циклы и наблюдаемое время на задачу](./assets/codex-astra-clean-five-repeats-input-cycles-time.png)
...
[Отчёт Astra](https://github.com/Rexarrior/skill-state-research/blob/main/experiments/codex-clean-comparison-20260908/REPORT-astra.md)
и [разбор нескольких траекторий](https://github.com/Rexarrior/skill-state-research/blob/main/journals/CODEX-ASTRA-NATIVE-EFFICIENCY-AUDIT-20260908.md).
...
[описании изменений ядра и условий запуска](https://github.com/Rexarrior/skill-state-research/blob/main/experiments/codex-astra-large-context-20260908/PROTOCOL.md).
...
![Пять повторов Codex/Astra с лимитами 2 МиБ: input, циклы и наблюдаемое время на задачу](./assets/codex-astra-large-context-five-repeats-input-cycles-time.png)
...
[Полный отчёт Astra, включая фактические размеры наблюдений](https://github.com/Rexarrior/skill-state-research/blob/main/experiments/codex-large-context-comparison-20260909/REPORT-astra.md).
...
![Пять повторов Codex/Sol с лимитами 2 МиБ: input, циклы и наблюдаемое время на задачу](./assets/codex-sol-large-context-five-repeats-input-cycles-time.png)
...
[Отчёт Sol с исходными и уточнёнными проверками](https://github.com/Rexarrior/skill-state-research/blob/main/experiments/codex-large-context-comparison-20260909/REPORT-sol.md).
...
8–9 сентября, Paper2 — 10 сентября. [Протокол](https://github.com/Rexarrior/skill-state-research/blob/main/experiments/codex-paper2-20260910/PROTOCOL.md)
...
![Codex/Sol: Paper2 против прежних Native и Paper — input, циклы и время на задачу](./assets/codex-sol-paper2-five-repeats-input-cycles-time.png)
...
![Codex/Astra: Paper2 против прежних Native и Paper — input, циклы и время на задачу](./assets/codex-astra-paper2-five-repeats-input-cycles-time.png)
...
[Отчёт Paper2 с исходными и уточнёнными оценками](https://github.com/Rexarrior/skill-state-research/blob/main/experiments/codex-paper2-20260910/REPORT.md),
[данные для таблиц и графиков](https://github.com/Rexarrior/skill-state-research/blob/main/experiments/codex-paper2-20260910/statistics.json),
[разбор прерывания](https://github.com/Rexarrior/skill-state-research/blob/main/experiments/codex-paper2-20260910/INTERRUPTION.md).
...
![Codex/Sol: Paper2 с большими и малыми лимитами — input, циклы и время на задачу](./assets/codex-sol-paper2-small-vs-large-input-cycles-time.png)
...
![Codex/Astra: Paper2 с большими и малыми лимитами — input, циклы и время на задачу](./assets/codex-astra-paper2-small-vs-large-input-cycles-time.png)
...
[Отчёт малого Paper2](https://github.com/Rexarrior/skill-state-research/blob/main/experiments/codex-paper2-small-context-20260910/REPORT.md),
[данные сравнения](https://github.com/Rexarrior/skill-state-research/blob/main/experiments/codex-paper2-small-context-20260910/statistics.json)
и [аудит завершений и усечений](https://github.com/Rexarrior/skill-state-research/blob/main/experiments/codex-paper2-small-context-20260910/trajectory-audit.json).
...
![Общий график четырёх режимов: input относительно Native слева, обращения на задачу справа](./assets/input-cycles-all-modes.png)
...
[Прежний общий рисунок только с input](./assets/input-by-task.png) также сохранён отдельно.
...
и [их учёт я вынес в отдельный отчёт](https://github.com/Rexarrior/skill-state-research/blob/main/experiments/article-20260904/AUXILIARY-USAGE.md).
...
его [расход на вспомогательные вызовы](https://github.com/Rexarrior/skill-state-research/blob/main/experiments/codex-sol-controls-20260906/AUXILIARY-USAGE.md) учтён отдельно.
...
Для тех, кто захочет разобраться глубже, есть [полный отчёт основной серии](https://github.com/Rexarrior/skill-state-research/blob/main/experiments/article-20260904/REPORT.md),
[условия эксперимента](https://github.com/Rexarrior/skill-state-research/blob/main/experiments/article-20260904/PROTOCOL.md) и
[план научного продолжения](https://github.com/Rexarrior/skill-state-research/blob/main/journals/RESEARCH-ARTICLE-PLAN.md).
